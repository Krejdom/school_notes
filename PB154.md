...
**DDL** (Data Definition Language) -- notace pro reprezentaci schématu databáze, tabulky uchovávané v datovém slovníku
...
* jedná se o tzv. DDL (Data Definition Langueage
...
**trigger** -- příkaz, který je vykonán automaticky systémem, jako vedlejší efekt modifikace databáze (insert, delete, update), může být omezen na určitý atribut, může se zreplikovat provedenou akci na další data
...
## Hashování
* bucket
* hashovací funkce by měla být **uniformní** a **náhodná**
* **otevřené** vs. **zavřené** (bucket = linked list) hashování
...
**atomičnost**, **trvanlivost**, **konzistence**, **izolace**
