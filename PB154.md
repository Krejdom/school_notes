...
**stupeň množina vztahů** -- většinou binární (vztah mezi dvěma entitami)
...
**generalizace** (bottom-up postup) -- kombinace svíce entitních množin, které sdílí stejné vlastnosti do nadřazené entitní množiny
