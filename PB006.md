...
# Podprogramy
Procedury, funkce, spousta dalších definicí
Formální parametry foo(a, b) jsou a a b
Aktuální parametry jsou pro foo(55, 6) 55 a 6 (taktéž argumenty)

Předávání hodnotou: v okamžiku volání překopíruju hodnotu do formálního parametru
