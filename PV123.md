...
**proporce** je poměrový vztah jednotlivosti vůči celku
...
**princip lineární perspektivy** je kunstrkce prostoru, 1. polovina 15. století, úběžník (vanishing point), horizont, kontrukce na jeden, na dva nebo na tři úběžníky
...
**ligatury** -- slití písmen

**symboly, číslice, písmena**

**diakritika** -- znaménko v okolí písmene pozměňující význam písmene

**účaří, střední dotažnice, střední výška písma, horní a dolní dotažnice, verzálkové a akcentová dotažnice, přetah**
...
**druh písma** - serifová, psané, zdobené
...
**kineograf** deníčky s nakrasleným filmem
...
**animatik** stavebnice plná rukou, hlav, těl... slouží k realizaci proškové stavebnice

**Hermína Týrlová** -- animátorka ze Zlína, plošková animace s textilem

**rootskopie** natočený film, který se překreslí
...
**McLuhanova teorie médií** -- globální vesnice (předpověď společnosti, která je propojená po celé planetě, ale chová se kmenově), horká média (vysokodefiniční, naplněna daty, př. fotografie), chladná média (nízkofrekvenční, musím si další věci domyslet, př. karikatura)
...
**prosumer** -- producent a konzument se setkávají v jednom (což umožňuje internet), zároveň tvoří i vstřevává
...
**pantograf** dokáže zmenšovat nebo zvětšovat v poměru
**linotype** -- stroj
...
**Sazební obrazec**, **zrcadlo sazby**

**odstavec** -- předsazení, odsazení, mezerou, grafickou zarážkou, odsazení vertikální; zarovnání: do bloku, na střed, doprava , doleva levý praporek & pravý praporek, zarovnání mimo osu

**proklad řádků** -- 120% stupně písma, je to mezera mezi řádky

**stránkový rejstřík** -- mřížka, na kteoru se zarovná účaří všech textů (při více sloupcíh), mřížka účaří

**parchanty** -- sirotci (1 řádek přetečený na nalší stránce), vdovy
...
**konotace** -- reakce a to, co si domyslíme, po působí umění; výklad, který si připojíme k obrazu
...
**semióza** -- proces přiřazování, pojmenování -- arbitrátní znak z přirozeného jazyka (přezdívka, neologismus, zástupný znak); označení-- přiřazeníá nejazykového znaku (tzv. motivovaného)
