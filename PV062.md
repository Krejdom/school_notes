...
**údržba souboru**: open, close, reorgainze
...
* struktorované × nestrukturované soubory
...
* požadavky: vytvářet, mazat, upravovat a číst soubory, měnit opravánění, restrukturalizovat, zálohovat, optimalizovat, umožnit paralelismus

#### Atributy soubrů
* jméno (vnitřní × vnější - číselné, v tabulce otevřených soubrů)
* typ
* organizace
* umístění
* rozměr
...
### Adresář
* typ souboru
* snažší vyhledávní, kolekce podobných souborů, možnost existence souborů se stejným jménem
...
* soubory jsou struktuované, mají atributy pojmenované (metadata) a nepojmenované (data)
...
* rozsálý index se těžko umisťuje do RAM, není vhodný pro dynamické struktury
...
* **násobné adresování** -- dvojté adresování, znovu se použije nová funkce modulo +1
...
**kořenový strom** -- vstupní stupeň roven jedné (kroě kořnového uzlu)

**list, podgraf, kosta grafu, podstrom**
...
**vyvážený, uspořádáný, neuspořádaný strom**
...
* štěpení a slévání
* uzelv B stromě řádu 3 má 3 syny
* hodnoty jsou i ve vnitřních uzlech stomu
...
* (funugje to jako pomůcka na morseovku)
* výška je dána délkou nejdelšího klíče



CHYBY V SLAJDECH:
04 - str. 3: aplykačnímy systémy -> aplykačními systémy
