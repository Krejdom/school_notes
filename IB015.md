...
|----------|:-----------------------:|-----------------------------------------------------------|
| is       |        přiřazení        | vyhodnocení + přiřazení do proměnné                       |
| ==       | syntaktická ekvivalence | identita                                                  |
| =:=      |   aritmetická rovnost   | vyhodnocení + porovnání dvou plně instranciovaných výrazů |
| =\=      | aritmetická nerovnost   | vyhodnocení + porovnání dvou plně instranciovaných výrazů |
