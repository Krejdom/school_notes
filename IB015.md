...
|pořadí    |1.     |2.   |3.      |4.    |5.         |
|:--------:|-------|-----|--------|------|-----------|
|národnost |Nor    |Dán  |Angličan|      |           |
|barva domu|žlutý  |modrá|červený |zelený|bílý       |
|kuřivo    |Dunhill|Blend|        |      |Blue Master|
...
send + more = money (kde písmenna reprezentují číslice

## Deklarativní vs. imperativní

### Deklarativní
* program je především formulace cíle a vrathu pořadovaného výsledku vápořtu k daným vstupům
...
\- náročnější tvorba kódu, požaduje schonost abstrkce
