...
dekonpozice -> mapování -> implementace
...
**granularita** -- počet úloh, na který lze úkol dekonponovat
  * fine-grained
  * coarse-graned
...
* jedna úloha je vyhrazena na přiřazování nových úloh procesům
* úlohy se mohou za běhu prohazovat mezi vlákny/procesy
...
**efektivita** - podíl zrychlení a počtu jednotek
...
**efektivita** -- `1 / (1 + (To/Ts))`, zachování efektivity - zvyšujeme počet procesních jednotek i množství dat současně
