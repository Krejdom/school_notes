...
= množina autonomních uzlů, které komunikakují každý s každým a formují síť a zabezpečují spojení decentalizovaným způsobem

* zařízení je v pohybu
* každý uzel má funcionalitu koncového uzlu i směrovače
* **jednohopová síť** -- každý je v dosahu s každým
* **multihopodová síť** -- mohu komunikovat i přes jiný uzel
...
* **Optimized Link State Routing (OLSR) Protocol**
    ...
    * nevýhody: nepodporuje multicast, má problémy s bezpenčností
...
## Multimédia
= informace složená z více typů (audio, video,...)
...
* **mobilita**
* **Session Management**
    * Media Description -- umožňuje distribuci informací o session
    * Session Announcement -- umožňuje účastníkům oznámit budoucí session
    * Session Identification -- identifikuje jednotlivé proudy médií (audio, video, text,...)
    * Session Control -- synchronizace (audia, videa, textu,...)

#### Session Description Protocol (SDP)
* formát pro popis přenášených médií (typ, kódování apod.)

#### Session Announcement Protocol (SAP)
* oznámení o existenci nové session

#### Real-Time Transport Protocol (RTP)
* obálkový protokol nad UDP
* přidává informace, jak mají být dané pakety zpracovávány

#### Real-Time Control Protocol (RTCP)
* kontrolní protokol pro RTP

#### Real-Time Streaming Protocol (RTSP)
* stremování živých přenosů